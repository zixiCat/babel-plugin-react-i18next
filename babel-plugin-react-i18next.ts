...
//                 translateFn(t.stringLiteral(expression.consequent.value))
//               );
//             }
//             // need to loop
//           } else if (path.node.expression.type === 'LogicalExpression') {
//             // Binary logical operators
//             const logicExpression = path.node.expression;
//             if (logicExpression.operator === '&&') {
//               // logicExpression.right.type === ""
//             } else if (logicExpression.operator === '||') {
//             } else if (logicExpression.operator === '??') {
//             }
//           }
//         }
